...
public class ProjectDao extends AbstractDao<Project, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property RootID = new Property(5, Long.class, "rootID", false, "ROOT_ID");
    };
    ...
    public Project readEntity(Cursor cursor, int offset) {
        Project entity = new Project( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // rootID
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Project entity, int offset) {
        ...
        entity.setRootID(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN PROJECT T0 ON T.'ROOT_ID'=T0.'_id'");
            builder.append(' ');
    ...
    protected Project loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Project root = loadCurrentOther(daoSession.getProjectDao(), cursor, offset);
        entity.setRoot(root);
