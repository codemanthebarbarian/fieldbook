...
// KEEP INCLUDES END
/**
 * Entity mapped to table LOCATION_META.
 */
public class LocationMeta extends EntityBase  implements MetaElement, UUIDSupport {
    ...
    private transient LocationMetaDao myDao;
    ...
    public LocationMeta(Long id) {
        this.id = id;
    }

    public LocationMeta(Long id, String rowGuid, String name, String value, long parentID) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getLocationMetaDao() : null;
    }
    ...
    public void setLocation(Location location) {
        ...
        synchronized (this) {
            ...
            location__resolvedKey = parentID;
        }
    }
