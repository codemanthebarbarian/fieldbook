...
// KEEP INCLUDES END
/**
 * Entity mapped to table GROUP_OBSERVATION_META.
 */
public class GroupObservationMeta extends EntityBase  implements MetaElement, UUIDSupport {
    ...
    private transient GroupObservationMetaDao myDao;

    private GroupObservation groupObservation;
    private Long groupObservation__resolvedKey;


    // KEEP FIELDS - put your custom fields here
    // KEEP FIELDS END

    public GroupObservationMeta() {
    }

    public GroupObservationMeta(Long id) {
        this.id = id;
    }

    public GroupObservationMeta(Long id, String rowGuid, String name, String value, long parentID) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getGroupObservationMetaDao() : null;
    }
    ...
    public GroupObservation getGroupObservation() {
        long __key = this.parentID;
        if (groupObservation__resolvedKey == null || !groupObservation__resolvedKey.equals(__key)) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            GroupObservationDao targetDao = daoSession.getGroupObservationDao();
            GroupObservation groupObservationNew = targetDao.load(__key);
            synchronized (this) {
                groupObservation = groupObservationNew;
            	groupObservation__resolvedKey = __key;
            }
        }
        return groupObservation;
    }

    public void setGroupObservation(GroupObservation groupObservation) {
        ...
        synchronized (this) {
            ...
            parentID = groupObservation.getId();
            groupObservation__resolvedKey = parentID;
        }
    }
