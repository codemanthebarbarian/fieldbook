 ...
 */
public class Project extends EntityBase  implements UUIDSupport {
    ...
    public Project(Long id, String rowGuid, String projectNumber, String name, String node, Long rootID) {
        this.id = id;
    ...
    public Project getRoot() {
        ...
        if (root__resolvedKey == null || !root__resolvedKey.equals(__key)) {
            ...
            Project rootNew = targetDao.load(__key);
            synchronized (this) {
                root = rootNew;
