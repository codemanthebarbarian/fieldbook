...
// KEEP INCLUDES END
/**
 * Entity mapped to table OBSERVATION_GROUP_META.
 */
public class ObservationGroupMeta extends EntityBase  implements MetaElement, UUIDSupport {
    ...
    private transient ObservationGroupMetaDao myDao;
    ...
    public ObservationGroupMeta() {
    }

    public ObservationGroupMeta(Long id) {
        this.id = id;
    }

    public ObservationGroupMeta(Long id, String rowGuid, String name, String value, long parentID) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getObservationGroupMetaDao() : null;
    }
    ...
    public void setObservationGroup(ObservationGroup observationGroup) {
        ...
        synchronized (this) {
            ...
            parentID = observationGroup.getId();
            observationGroup__resolvedKey = parentID;
        }
    }
